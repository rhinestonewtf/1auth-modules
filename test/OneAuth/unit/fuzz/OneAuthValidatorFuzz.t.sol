...
contract OneAuthValidatorFuzzTest is BaseTest {
    ...
    function setUp() public override {
        ...
        validator.onInstall(abi.encode(keyIds, creds, address(0), address(0), uint8(0), bytes32(0), bytes32(0)));
    }
    ...
    function testFuzz_OnInstall_RejectsRandomPubKeys(bytes32 x, bytes32 y) public {
        ...
        try freshValidator.onInstall(abi.encode(keyIds, creds, address(0), address(0), uint8(0), bytes32(0), bytes32(0))) {
