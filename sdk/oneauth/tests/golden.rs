...
use oneauth::digest;
use oneauth::merkle::{keccak256, MerkleTree};
use oneauth::signature::{
...
/// Source of truth: Solidity contract (OneAuthValidator + OneAuthRecoveryBase)
const GOLDEN_PATH: &str = "../../test/OneAuth/fixtures/golden-vectors.json";
