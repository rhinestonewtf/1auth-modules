...
export const getDigest: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => [number, number, number, number];
export const passkeyDigest: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => [number, number, number, number];
export const passkeyMultichain: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const getPasskeyDigestTypedData: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => [number, number];
...
export const getAccountLeaf: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const getMultiAccountDigest: (a: number, b: number, c: number, d: number) => [number, number, number, number];
